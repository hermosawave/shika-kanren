...
■上記価格は代理購入の為、オーダー後に変更される可能性があります。</span></span><br/>
            <span class="body1_blk"><span class="style5">■海外送金をご利用の場合は、銀行振り込み手数料として$35別途請求致します。<br>
■アメリカから日本への送料は、発送方法や条件に応じて加算されます。<br>
■米国内消費税及び送料が、商品によっては発注時に加算される事がございます。<br>
            ■着払いや代引きの場合は、着払い手数料が加算されます。<br>
            ■日本での税金として、送料と商品代の合計に消費税(5%)が請求されます。<br>
