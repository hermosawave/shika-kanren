      ...
      <table width="540" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="540" valign="top">
             <img src="../pic/titlebar/regist2.gif" alt="新規会員登録" width="540" height="25"></td>
        </tr>
        <tr>
        ...
        会員登録の前に、本ページの下(<a href="#toroku">こちら</a>)を必ずご覧下さい。</div></td>
            </tr>
            <tr>
              <td height="5">
              <span class="style6"><img src="../pic/space.gif" width="1" height="10"></span>
                ...
                <table width="539" border="0" cellpadding="2" cellspacing="1" bgcolor="#000000" class="test">
                  ...
                  <tr bgcolor="#FFFFFF">
                    ...
                    <td width="413" height="2" align="left" valign="top" class="tbl_right">                      <div align="left">
                        ...
                        <span class="body3_red">※必修</span>    </div></td>
                  </tr>
                  <tr bgcolor="#FFFFFF">
                    ...
                    <?php echo $hm->Zb('rs:def:name_alpha'); ?>
                      <span class="body3_red">※必修</span></td>
                  </tr>
                  <tr bgcolor="#FFFFFF">
                  ...
                  <tr bgcolor="#FFFFFF">
                    <td width="123" height="10" align="center" class="tbl_left"><div align="right">旧パスワード：</div></td>
                    <td width="413" height="10" align="left" valign="top" class="tbl_right">                      <div align="left">
                        <?php echo $hm->Zb('rs:def:password_old'); ?>
                        <span class="body3_red">※パスワード変更時のみ入力下さい。</span><br>
(半角英数8～16文字)</div></td>
                  <tr bgcolor="#FFFFFF">
                    <td width="123" height="10" align="center" class="tbl_left"><div align="right">新パスワード：</div></td>
                    <td width="413" height="10" align="left" valign="top" class="tbl_right">                      <div align="left">
...
(半角英数8～16文字)</div></td>
                  ...
                  <tr bgcolor="#FFFFFF">
                    <td width="123" height="10" align="center" class="tbl_left"><div align="right">新パスワード確認：</div></td>
                    <td width="413" height="10" align="left" valign="top" class="tbl_right">                      <div align="left">
                        <?php echo $hm->Zb('rs:def:password_new_conf'); ?>
                        <span class="body3_red">※パスワード変更時のみ入力下さい。</span><br>
(半角英数8～16文字)</div></td>
                  </tr>
                  <tr bgcolor="#FFFFFF">
...
-->
	<td align='center'>
		<?php echo $hm->Button( array( '<>'=>'<html/>', 'name'=>"_sc=_this/edit_done&", 'value'=>"更新する", 'class'=>'def_button' ) ); ?>
	</td>
</tr>
</table>
</div>
...
e-mail：<a href="mailto:toroku@shika-kanren.com">toroku@shika-kanren.com</a>
    ...
    余分な手数料や時間がかからないことなどから、クレジットカードでの決済をお勧め致します。</td>
            ...
            <tr>
              <td align='left' bgcolor="#E8E8E8" class="bodytop1_blk">■不良品、返品について</td>
            </tr>
            <tr>
