...
<?php $hm->Title( __FILE__, STR_PAGE_TITLE, RSTR_CATEGORY, RSTR_SEARCH ); ?>
...
<?php include(INC_BODY_INFO); ?>
	...
	<tr>
		...
		<td align="right">カテゴリ名 : </td>
		<td align="left"><?php echo $hm->Zb( 'sp:def:category_name' ); ?></td>
	</tr>
	...
	<table class='data_table' border="1" cellspacing="0" cellpadding="0">
		...
		<tr style='background-color:<?php echo ( $hm->zb('rs:def:row_idx') % 2 == 0 ? COLOR_ROW1 : COLOR_ROW2 ); ?>;'>
			...
			<td style='text-align:left;'><?php echo $hm->Zb('rs:def:category_name'); ?></td>
		</tr>
		<?php } ?>
