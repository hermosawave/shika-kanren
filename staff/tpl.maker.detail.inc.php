...
<?php $hm->Title( __FILE__, STR_PAGE_TITLE, RSTR_MAKER, $hm->Zb( 'page:caption_verb' ) ); ?>
<?php 
...
<?php include(INC_BODY_INFO); ?>
	...
	<!-- [BEGIN] basic_info -->
	<?php echo $hm->SectBegin( $hm->Zb( 'page:caption_verb' ) . " [" . RSTR_MAKER ."]" ); ?>
	...
	<tr>
		...
		<td class='column_value'><?php echo $hm->Zb('rs:def:maker_id'); ?></td>
	</tr>
	<?php } ?>
	...
	<tr>
		...
		<td class='column_value'><?php echo $hm->Zb('rs:def:maker_name'); ?>
		</td>
	</tr>
	...
	<tr>
		...
		<td class='column_value'><?php echo $hm->Zb('rs:def:url'); ?>
		</td>
	</tr>
