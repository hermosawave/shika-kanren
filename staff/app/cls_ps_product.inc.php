...
class cls_ps_product extends cls_ps_base
{
	...
	function CommandProc( &$sc )
	{
		...
		case 'edit_inp_file_upload':

			//-- [BEGIN] Set default destination
			$sc->SetNextSc( "edit_inp_pb" );
			...
			//-- [BEGIN] Go to edit_inp_pb
			$sc->SetNextSc( "edit_inp_pb" );
			//-- [END] Go to edit_inp_pb

			break;

		case 'edit_inp_file_remove':
		...
		case 'reg_inp_file_upload':

			//-- [BEGIN] Set default destination
			$sc->SetNextSc( "reg_inp_pb" );
			//-- [END] Set default destination
			...
			//-- [BEGIN] Go to reg_inp_pb
			$sc->SetNextSc( "reg_inp_pb" );
			//-- [END] Go to reg_inp_pb

			break;

		case 'reg_inp_file_remove':
