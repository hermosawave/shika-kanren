...
<?php $hm->Title( __FILE__, STR_PAGE_TITLE, RSTR_PRODUCT, RSTR_SEARCH ); ?>
...
<?php include(INC_BODY_INFO); ?>
	...
	<tr>
		...
		<td align="left"><?php echo $hm->Zb( 'sp:def:product_id' ); ?></td>
	...
	<tr>
		...
		<td align="left"><?php echo $hm->Zb( 'sp:def:product_code' ); ?></td>
		<td align="right">商品名 : </td>
		<td align="left"><?php echo $hm->Zb( 'sp:def:product_name' ); ?></td>
		<td align="right">&nbsp;</td>
		<td align="left">&nbsp;</td>
	</tr>
	...
	<tr>
		...
		<td align="left"><?php echo $hm->Zb( 'sp:def:category_id' ); ?></td>
	...
	<table class='data_table' border="1" cellspacing="0" cellpadding="0">
		...
		<tr style='background-color:<?php echo ( $hm->zb('rs:def:row_idx') % 2 == 0 ? COLOR_ROW1 : COLOR_ROW2 ); ?>;'>
			<td style='text-align:left;'><?php echo $hm->Zb('rs:def:product_id'); ?></td>
			<?php
			...
			<td style='text-align:right;'><?php echo $hm->Zb('rs:def:view_order'); ?></td>
			<td style='text-align:left;'><?php echo $hm->Zb('rs:def:product_code'); ?></td>
			<td style='text-align:left;'><?php echo $hm->Zb('rs:def:product_name'); ?></td>
			<td style='text-align:left;'><?php echo $hm->Zb('rs:def:category_id'); ?></td>
			<td style='text-align:left;'><?php echo $hm->Zb('rs:def:maker_id'); ?></td>
			<td style='text-align:right;'>$<?php echo $hm->Zb('rs:def:price'); ?></td>
		</tr>
		<?php } ?>
